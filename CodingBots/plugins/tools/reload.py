...
from CodingBots import app
from CodingBots.core.call import sxyseller
from CodingBots.misc import db
from CodingBots.utils.database import get_assistant, get_authuser_names, get_cmode
from CodingBots.utils.decorators import ActualAdminCB, AdminActual, language
from CodingBots.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await sxyseller.stop_stream_force(message.chat.id)
    except:
        pass
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await sxyseller.stop_stream_force(chat_id)
        except:
            pass
