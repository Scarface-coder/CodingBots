...
from CodingBots.utils import AdminRightsCheck
from CodingBots.utils.database import is_active_chat, is_nonadmin_chat
from CodingBots.utils.decorators.language import languageCB
from CodingBots.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await sxyseller.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
